...
namespace MiniAdventure.Interfaces
{
    ...
    {
        public static string[] EnemyNames = { "Worm", "Dog", "Monkey", "Candles" };
        public static int[] HpValue = { 10, 12, 16, 20 };
        public static int[] DamageValue = { 3, 4, 8, 1 };
        public static int[] GoldRewardValue = { 2, 3, 5, 6 };
        public static string[] EnemyNarrtives = { 
       ...
       public static  string[] EnemyImages = { "\r\n      _        ,..\r\n ,--._\\\\_.--, (-00)\r\n; #         _:(  -)\r\n:          (_____/\r\n:            :\r\n '.___..___.`", 
        ...
        public static int PreviousSecondIndex = -1;
